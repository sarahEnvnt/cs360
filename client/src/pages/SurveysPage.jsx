  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <StatBox icon="😀" label="Overall CSAT" value={k.overallAvgCsat ? k.overallAvgCsat + "%" : "N/A"} color={k.overallAvgCsat >= 80 ? T.ok : T.warn} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {summary.map(a => (
              <div key={a.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 14px", background: "rgba(255,255,255,.02)", borderRadius: 8 }}>
                ...
                {a.avgCsat != null && <Badge color={a.avgCsat >= 80 ? T.ok : a.avgCsat >= 60 ? T.warn : T.err}>CSAT: {a.avgCsat}%</Badge>}
